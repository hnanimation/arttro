...
1. Open an issue or contact the project maintainer to discuss the idea.
2. Wait for approval before starting major work.
3. Submit a clean pull request to the official repository.
4. Keep commits focused and clearly described.
5. Do not create independent forks, releases, or commercial derivatives.
...
This project is protected to remain non-commercial, contribution-controlled, and owner-owned. Contributions are accepted only through the official project process.
